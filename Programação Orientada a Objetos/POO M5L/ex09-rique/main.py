...
def creat_invoice():
    invoice1 = Invoice(1, "Teclado", 2, 150.0)
    invoice2 = Invoice(2, "Mouse", 0, 80.0)  # quantidade não positiva
    invoice3 = Invoice(3, "Monitor", 1, -300.0)  # preço não positivo
...
def main(): 
    list_invoices, amounts = creat_invoice()
